      ...
      <div className='container'>
        ...
        <div className='pb-10 mb-5'>
          <div className="flex flex-row-reverse xl:flex-row items-center gap-3 pt-20 xl:pt-0 max-md:flex-col-reverse">
            <div className='lg:hidden absolute top-0 left-0 bottom-0 w-full bg-green-light5 z-[-1]'></div>
            <div>
        ...
        <div className=''>
          ...
          <div className='relative flex gap-24'>
            <div className='flex flex-col xl:flex-row gap-8 items-start mt-20'>
              <p className='text-[100px] max-xsm:text-[60px] font-bold text-green-light4 leading-none'>01</p>
          ...
          <div className='relative flex flex-row-reverse gap-24'>
            <div className='flex gap-8 items-start mt-20 max-md:flex-col'>
              <p className='text-[100px] max-xsm:text-[60px] font-bold text-green-light4 leading-none'>02</p>
          ...
          <div className='relative flex gap-24'>
            <div className='flex gap-8 items-start mt-20 max-md:flex-col'>
              <p className='text-[100px] max-xsm:text-[60px] font-bold text-green-light4 leading-none'>03</p>
          ...
          <div className='mt-10'>
            ...
            <div className='flex flex-wrap justify-center gap-5'>
              <div className='flex flex-col items-center p-10 max-w-115 bg-green-light5 rounded-md max-md:p-4'>
          ...
          <div className='mt-10'>
            ...
            <div className='flex flex-wrap justify-center gap-5'>
              <div className='flex flex-col p-10 max-w-115 bg-green-light5 rounded-md max-md:p-4'>
